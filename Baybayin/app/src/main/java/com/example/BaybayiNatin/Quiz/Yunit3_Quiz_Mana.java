...
import static com.example.BaybayiNatin.Fragment.Home.Yunit3_ngapa;
...
import com.example.BaybayiNatin.databinding.Yunit3QuizManaBinding;

public class Yunit3_Quiz_Mana extends AppCompatActivity {

    Yunit3QuizManaBinding binding;
    public static final String Yunit3_Quiz_4_Score = "Yunit3_Quiz4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = Yunit3QuizManaBinding.inflate(getLayoutInflater());
        ...
        View alertCustomDialog = LayoutInflater.from(Yunit3_Quiz_Mana.this).inflate(R.layout.dialog_done_quiz, null);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Yunit3_Quiz_Mana.this);
        ...
        View alertCustomDialog_f = LayoutInflater.from(Yunit3_Quiz_Mana.this).inflate(R.layout.dialog_failed_quiz, null);
        AlertDialog.Builder alertDialog_f = new AlertDialog.Builder(Yunit3_Quiz_Mana.this);
                ...
                public void run() {
                    if (v == choice_1) {
                        ...
                        if (suriin.getText().equals("Suriin")) {
                            ...
                            if (question.getText().equals(getString(R.string.yunit3_quiz4_question1))) {
                            ...
                            //Question 2
                            if (question.getText().equals(getString(R.string.yunit3_quiz4_question2))) {
                            ...
                            //Question 3
                            if (question.getText().equals(getString(R.string.yunit3_quiz4_question3))) {
                            ...
                            //Question 4
                            if (question.getText().equals(getString(R.string.yunit3_quiz4_question4))) {
                            ...
                            //Question 5
                            if (question.getText().equals(getString(R.string.yunit3_quiz4_question5))) {
                            ...
                            if (yunit3_quiz != -1) {
                                editor.putInt(Yunit3_Quiz_4_Score, yunit3_quiz);
                                editor.commit();
                            }
                            yunit3_quiz_score = preferences.getInt(Yunit3_Quiz_4_Score, 0);
                            ...
                            if (question.getText().equals(getString(R.string.yunit3_quiz4_question1))) {
                                question.setText(R.string.yunit3_quiz4_question2);
                                choice_1.setText(R.string.yunit3_quiz4_q2_choice1);
                                choice_2.setText(R.string.yunit3_quiz4_q2_choice2);
                                choice_3.setText(R.string.yunit3_quiz4_q2_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                            ...
                            } else if (question.getText().equals(getString(R.string.yunit3_quiz4_question2))) {
                                question.setText(R.string.yunit3_quiz4_question3);
                                choice_1.setText(R.string.yunit3_quiz4_q3_choice1);
                                choice_2.setText(R.string.yunit3_quiz4_q3_choice2);
                                choice_3.setText(R.string.yunit3_quiz4_q3_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                                suriin.setText("Suriin");
                                ...
                                choice_2.setEnabled(true);
                                choice_3.setEnabled(true);
                            } else if (question.getText().equals(getString(R.string.yunit3_quiz4_question3))) {
                                question.setText(R.string.yunit3_quiz4_question4);
                                choice_1.setText(R.string.yunit3_quiz4_q4_choice1);
                                choice_2.setText(R.string.yunit3_quiz4_q4_choice2);
                                choice_3.setText(R.string.yunit3_quiz4_q4_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                                suriin.setText("Suriin");
                                ...
                                choice_2.setEnabled(true);
                                choice_3.setEnabled(true);
                            } else if (question.getText().equals(getString(R.string.yunit3_quiz4_question4))) {
                                question.setText(R.string.yunit3_quiz4_question5);
                                choice_1.setText(R.string.yunit3_quiz4_q5_choice1);
                                choice_2.setText(R.string.yunit3_quiz4_q5_choice2);
                                choice_3.setText(R.string.yunit3_quiz4_q5_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                                suriin.setText("Suriin");
                                ...
                                choice_2.setEnabled(true);
                                choice_3.setEnabled(true);
                            } else if (question.getText().equals(getString(R.string.yunit3_quiz4_question5))) {
        ...
        d_magpatuloy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                editor.putString(Yunit3_ngapa,"ngapa");
                editor.commit();
                Intent intent = new Intent(Yunit3_Quiz_Mana.this, MainActivity.class);
        ...
        f_ulitin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                editor.putString(Home.Quiz_Note, "mana");
                editor.commit();
                Intent intent = new Intent(Yunit3_Quiz_Mana.this, Quiz_Note.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
