...
import static com.example.BaybayiNatin.Fragment.Home.Yunit3_mana;
...
import com.example.BaybayiNatin.databinding.Yunit3QuizHaLaBinding;

public class Yunit3_Quiz_HaLa extends AppCompatActivity {

    Yunit3QuizHaLaBinding binding;

    public static final String Yunit3_Quiz_3_Score = "Yunit3_Quiz3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = Yunit3QuizHaLaBinding.inflate(getLayoutInflater());
        ...
        View alertCustomDialog = LayoutInflater.from(Yunit3_Quiz_HaLa.this).inflate(R.layout.dialog_done_quiz, null);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Yunit3_Quiz_HaLa.this);
        ...
        View alertCustomDialog_f = LayoutInflater.from(Yunit3_Quiz_HaLa.this).inflate(R.layout.dialog_failed_quiz, null);
        AlertDialog.Builder alertDialog_f = new AlertDialog.Builder(Yunit3_Quiz_HaLa.this);
                ...
                public void run() {
                    if (v == choice_1) {
                        ...
                        if (suriin.getText().equals("Suriin")) {
                            ...
                            if (question.getText().equals(getString(R.string.yunit3_quiz3_question1))) {
                            ...
                            //Question 2
                            if (question.getText().equals(getString(R.string.yunit3_quiz3_question2))) {
                            ...
                            //Question 3
                            if (question.getText().equals(getString(R.string.yunit3_quiz3_question3))) {
                            ...
                            //Question 4
                            if (question.getText().equals(getString(R.string.yunit3_quiz3_question4))) {
                            ...
                            //Question 5
                            if (question.getText().equals(getString(R.string.yunit3_quiz3_question5))) {
                            ...
                            if (yunit3_quiz != -1) {
                                editor.putInt(Yunit3_Quiz_3_Score, yunit3_quiz);
                                editor.commit();
                            }
                            yunit3_quiz_score = preferences.getInt(Yunit3_Quiz_3_Score, 0);
                            ...
                            if (question.getText().equals(getString(R.string.yunit3_quiz3_question1))) {
                                question.setText(R.string.yunit3_quiz3_question2);
                                choice_1.setText(R.string.yunit3_quiz3_q2_choice1);
                                choice_2.setText(R.string.yunit3_quiz3_q2_choice2);
                                choice_3.setText(R.string.yunit3_quiz3_q2_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                            ...
                            } else if (question.getText().equals(getString(R.string.yunit3_quiz3_question2))) {
                                question.setText(R.string.yunit3_quiz3_question3);
                                choice_1.setText(R.string.yunit3_quiz3_q3_choice1);
                                choice_2.setText(R.string.yunit3_quiz3_q3_choice2);
                                choice_3.setText(R.string.yunit3_quiz3_q3_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                                suriin.setText("Suriin");
                                ...
                                choice_2.setEnabled(true);
                                choice_3.setEnabled(true);
                            } else if (question.getText().equals(getString(R.string.yunit3_quiz3_question3))) {
                                question.setText(R.string.yunit3_quiz3_question4);
                                choice_1.setText(R.string.yunit3_quiz3_q4_choice1);
                                choice_2.setText(R.string.yunit3_quiz3_q4_choice2);
                                choice_3.setText(R.string.yunit3_quiz3_q4_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                                suriin.setText("Suriin");
                                ...
                                choice_2.setEnabled(true);
                                choice_3.setEnabled(true);
                            } else if (question.getText().equals(getString(R.string.yunit3_quiz3_question4))) {
                                question.setText(R.string.yunit3_quiz3_question5);
                                choice_1.setText(R.string.yunit3_quiz3_q5_choice1);
                                choice_2.setText(R.string.yunit3_quiz3_q5_choice2);
                                choice_3.setText(R.string.yunit3_quiz3_q5_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                                suriin.setText("Suriin");
                                ...
                                choice_2.setEnabled(true);
                                choice_3.setEnabled(true);
                            } else if (question.getText().equals(getString(R.string.yunit3_quiz3_question5))) {
        ...
        d_magpatuloy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                editor.putString(Yunit3_mana, "mana");
                editor.commit();
                Intent intent = new Intent(Yunit3_Quiz_HaLa.this, MainActivity.class);
        ...
        f_ulitin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                editor.putString(Home.Quiz_Note, "hala");
                editor.commit();
                Intent intent = new Intent(Yunit3_Quiz_HaLa.this, Quiz_Note.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
