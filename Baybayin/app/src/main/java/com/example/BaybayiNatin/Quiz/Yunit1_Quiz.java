...
import com.example.BaybayiNatin.databinding.Yunit1QuizBinding;

public class Yunit1_Quiz extends AppCompatActivity {

    Yunit1QuizBinding binding;
    SharedPreferences preferences;
    SharedPreferences.Editor editor;
    private static final String SHARED_PREF_NAME= "MyPreferences";

    private static final String Yunit2_Intro = "intro";

    public static final String Yunit1_Quiz_Score = "Yunit1_Quiz";

    private int choices;

    private int yunit1_quiz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = Yunit1QuizBinding.inflate(getLayoutInflater());
        ...
        //to store the quiz score



        View alertCustomDialog = LayoutInflater.from(Yunit1_Quiz.this).inflate(R.layout.dialog_done_quiz, null);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Yunit1_Quiz.this);
        ...
        View alertCustomDialog_f = LayoutInflater.from(Yunit1_Quiz.this).inflate(R.layout.dialog_failed_quiz, null);
        AlertDialog.Builder alertDialog_f = new AlertDialog.Builder(Yunit1_Quiz.this);
                ...
                public void run() {
                    if (v == choice_1) {
                        ...
                        if (suriin.getText().equals("Suriin")){
                            ...
                            if (question.getText().equals(getString(R.string.question1))) {
                            ...
                            //Question 2
                            if (question.getText().equals(getString(R.string.question2))) {
                            ...
                            //Question 3
                            if (question.getText().equals(getString(R.string.question3))) {
                            ...
                            //Question 4
                            if (question.getText().equals(getString(R.string.question4))) {
                            ...
                            //Question 5
                            if (question.getText().equals(getString(R.string.question5))) {
                            ...
                            yunit1_quiz = addScore(q1, q2, q3, q4, q5);
                            if (yunit1_quiz!= -1){
                                editor.putInt(Yunit1_Quiz_Score, yunit1_quiz);
                                editor.commit();
                            }
                            yunit1_quiz_score = preferences.getInt(Yunit1_Quiz_Score, 0);
                            if (yunit1_quiz_score != -1){
                                d_score.setText(yunit1_quiz_score + "/ 5");
                                f_score.setText(yunit1_quiz_score + "/ 5");
                            }
                            ...
                            if (question.getText().equals(getString(R.string.question1))) {
                                ...
                                choice_1.setText(R.string.q2_choice1);
                                choice_2.setText(R.string.q2_choice2);
                                choice_3.setText(R.string.q2_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                            ...
                            else if (question.getText().equals(getString(R.string.question2))) {
                                question.setText(R.string.question3);
                                choice_1.setText(R.string.q3_choice1);
                                choice_2.setText(R.string.q3_choice2);
                                choice_3.setText(R.string.q3_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                                suriin.setText("Suriin");
                            ...
                            else if (question.getText().equals(getString(R.string.question3))) {
                                question.setText(R.string.question4);
                                choice_1.setText(R.string.q4_choice1);
                                choice_2.setText(R.string.q4_choice2);
                                choice_3.setText(R.string.q4_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                                suriin.setText("Suriin");
                            ...
                            else if (question.getText().equals(getString(R.string.question4))) {
                                question.setText(R.string.question5);
                                choice_1.setText(R.string.q5_choice1);
                                choice_2.setText(R.string.q5_choice2);
                                choice_3.setText(R.string.q5_choice3);
                                choice_1.setBackgroundResource(R.drawable.container_question_black);
                                choice_2.setBackgroundResource(R.drawable.container_question_black);
                                choice_3.setBackgroundResource(R.drawable.container_question_black);
                                suriin.setText("Suriin");
                                ...
                                else if (question.getText().equals(getString(R.string.question5))) {

                                }
                        } else if (suriin.getText().equals("Isumite")) {
                          if (yunit1_quiz_score > 2){
        ...
        d_magpatuloy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                editor.putString(Yunit2_Intro, "Intro");
                editor.commit();
                Intent intent = new Intent(com.example.BaybayiNatin.Quiz.Yunit1_Quiz.this, MainActivity.class);
        ...
        f_ulitin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.commit();
                Intent intent = new Intent(com.example.BaybayiNatin.Quiz.Yunit1_Quiz.this, Quiz_Note.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
